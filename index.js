const express = require('') // ### Q1 ### get the "express" module
const cors =  // ### Q2 ### get the "cors" module
const port = 3000
const app = express()
...
// app.('/inventory/retrieve/:itemname', (req, res) => {
...
// app.('/inventory/remove/:name', (req, res) => {
